...
class PromotionModuleService extends (0, utils_1.MedusaService)({
    ...
    async registerCampaignBudgetUsageByAttribute_(budgetId, attributeValue, sharedContext = {}) {
        ...
        }, { relations: ["budget"], options: { refresh: true } }, sharedContext);
    ...
    async registerUsage(computedActions, registrationContext, sharedContext = {}) {
        ...
        let existingPromotions = await this.listActivePromotions_({ code: promotionCodes }, { relations: ["campaign", "campaign.budget", "campaign.budget.usages"] }, sharedContext);
        ...
        const lockBudgetIds = Array.from(new Set(existingPromotions
        ...
        if (!knex) {
            throw new utils_1.MedusaError(utils_1.MedusaError.Types.UNEXPECTED_STATE, "registerUsage must run inside a transaction to serialize concurrent usage registration.");
        }
        ...
        existingPromotions = await this.listActivePromotions_({ code: promotionCodes }, {
