    ...
    return function (target, propertyKey, descriptor) {
        ...
        descriptor.value = function (...args) {
            ...
            if (!(0, common_1.isPresent)(resourceWithManager) &&
                ...
                throw new Error(`Could not find a manager in the context. Ensure that "${managerProperty}" is set on your service and points to a repository — e.g. extend MedusaService(...), which provides "baseRepository_" automatically.`);
            }
