import { EventBusTypes, EventMetadata, InterceptorSubscriber, InternalModuleDeclaration } from "@medusajs/types";
export declare abstract class AbstractEventBusModuleService implements EventBusTypes.IEventBusModuleService {
     ...
     */
    protected parseEventMetadataDates(metadata?: EventMetadata): EventMetadata | undefined;
}
