export declare const ProductEvents: {
    ...
    PRODUCT_PRODUCT_OPTION_CREATED: "product.product-product-option.created";
    PRODUCT_PRODUCT_OPTION_VALUE_CREATED: "product.product-product-option-value.created";
    ...
    PRODUCT_PRODUCT_OPTION_UPDATED: "product.product-product-option.updated";
    PRODUCT_PRODUCT_OPTION_VALUE_UPDATED: "product.product-product-option-value.updated";
    ...
    PRODUCT_PRODUCT_OPTION_DELETED: "product.product-product-option.deleted";
    PRODUCT_PRODUCT_OPTION_VALUE_DELETED: "product.product-product-option-value.deleted";
    ...
    PRODUCT_PRODUCT_OPTION_RESTORED: "product.product-product-option.restored";
    PRODUCT_PRODUCT_OPTION_VALUE_RESTORED: "product.product-product-option-value.restored";
    ...
    PRODUCT_PRODUCT_OPTION_ATTACHED: "product.product-product-option.attached";
    PRODUCT_PRODUCT_OPTION_VALUE_ATTACHED: "product.product-product-option-value.attached";
    ...
    PRODUCT_PRODUCT_OPTION_DETACHED: "product.product-product-option.detached";
    PRODUCT_PRODUCT_OPTION_VALUE_DETACHED: "product.product-product-option-value.detached";
