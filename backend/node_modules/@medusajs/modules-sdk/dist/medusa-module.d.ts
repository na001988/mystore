import { InternalModuleDeclaration, LinkModuleDefinition, LoadedModule, MedusaContainer, ModuleBootstrapDeclaration, ModuleDefinition, ModuleExports, ModuleJoinerConfig, ModuleResolution, SearchTypes } from "@medusajs/types";
declare global {
...
declare class MedusaModule {
    ...
    static onApplicationStart(onApplicationStartCb?: () => void): Promise<void>;
     ...
     */
    static setSearchIndex(definition: SearchTypes.SearchIndexDefinition, filePath?: string): void;
    static getSearchIndexes(): SearchTypes.SearchIndexDefinition[];
