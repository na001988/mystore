import { ExternalModuleDeclaration, ILinkMigrationsPlanner, InternalModuleDeclaration, LoadedModule, MedusaContainer, ModuleServiceInitializeOptions, RemoteQueryFunction } from "@medusajs/types";
import { GraphQLUtils, Modules, ModulesSdkUtils } from "@medusajs/utils";
 ...
 * instead.
 */
export declare function verifyMigrationConnection(knex: ReturnType<typeof ModulesSdkUtils.createPgConnection>): Promise<void>;
