...
Please make sure that the provider is registered in the container and it is configured correctly in your project configuration file.`;
    ...
    async deletePaymentMethod(providerId, input) {
        const provider = this.retrieveProvider(providerId);
        if (!provider.deletePaymentMethod) {
            __classPrivateFieldGet(this, _PaymentProviderService_logger, "f").warn(`Provider ${providerId} does not support deleting payment methods`);
            return {};
        }
