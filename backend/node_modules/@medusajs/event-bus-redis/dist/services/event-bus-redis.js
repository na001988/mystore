...
class RedisEventBusService extends utils_1.AbstractEventBusModuleService {
    ...
    async emit(eventsData, options = {}) {
        let eventsDataArray = (Array.isArray(eventsData) ? eventsData : [eventsData]).map((eventData) => ({
            ...eventData,
        ...
        if (eventsToEmit.length) {
            eventsToEmit.forEach((eventData) => this.callInterceptors(eventData, { isGrouped: false }));
