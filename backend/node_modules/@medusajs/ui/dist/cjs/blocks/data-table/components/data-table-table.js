        ...
        instance.emptyState === types_1.DataTableEmptyState.POPULATED &&
            (instance.enableColumnOrder ? (React.createElement(core_1.DndContext, { sensors: sensors, collisionDetection: core_1.closestCenter, onDragEnd: handleDragEnd },
                React.createElement("div", { ref: scrollableRef, onScroll: handleHorizontalScroll, className: "min-h-0 w-full flex-1 overflow-auto overscroll-auto border-y" },
                    React.createElement(table_1.Table, { className: "relative isolate w-full table-fixed" },
                            ...
                            React.createElement(sortable_1.SortableContext, { items: sortableItems, strategy: sortable_1.horizontalListSortingStrategy }, headerGroup.headers.map((header, idx) => {
                                ...
                                return (React.createElement(HeaderCellComponent, { key: header.id, id: header.id, isFirstColumn: isFirstColumn, className: (0, clx_1.clx)("whitespace-nowrap", {
                                    ...
                                    React.createElement(Wrapper, { type: canSort ? "button" : undefined, onClick: canSort ? sortHandler : undefined, onMouseDown: canSort
                                        ...
                                        canSort && isRightAligned && (React.createElement(data_table_sorting_icon_1.DataTableSortingIcon, { direction: sortDirection, firstDirection: firstSortDirection })),
                ...
                React.createElement(table_1.Table, { className: "relative isolate w-full" },
                    ...
                    React.createElement(table_1.Table.Body, { className: "border-b-0 border-t-0" }, instance.getRowModel().rows.map((row) => {
                        return (React.createElement(table_1.Table.Row, { key: row.id, onMouseEnter: () => (hoveredRowId.current = row.id), onMouseLeave: () => (hoveredRowId.current = null), onClick: (e) => { var _a; return (_a = instance.onRowClick) === null || _a === void 0 ? void 0 : _a.call(instance, e, row); }, className: (0, clx_1.clx)("group/row last-of-type:border-b-0", {
                            ...
                            const isSpecialCell = isSelectCell || isActionCell;
                            const isFirstColumn = hasSelect ? idx === 1 : idx === 0;
                            return (React.createElement(table_1.Table.Cell, { key: cell.id, className: (0, clx_1.clx)("items-stretch whitespace-nowrap", {
                                    "w-[calc(20px+24px+24px)] min-w-[calc(20px+24px+24px)] max-w-[calc(20px+24px+24px)]": isSelectCell,
                                    "w-[calc(28px+24px+4px)] min-w-[calc(28px+24px+4px)] max-w-[calc(28px+24px+4px)]": isActionCell,
                                    "bg-ui-bg-base group-hover/row:bg-ui-bg-base-hover transition-fg sticky": isFirstColumn || isSelectCell,
                                    "after:absolute after:inset-y-0 after:right-0 after:h-full after:w-px after:bg-transparent after:content-['']": isFirstColumn,
...
function renderAlignedCell(cell) {
    ...
    const rendered = (0, react_table_1.flexRender)(cell.column.columnDef.cell, cell.getContext());
    const content = wantTooltip ? (React.createElement(TruncatedCell, null, rendered)) : (rendered);
    if (!["right", "center"].includes(align)) {
        return content;
    }
    return (React.createElement("div", { className: (0, clx_1.clx)("flex min-w-0 items-center", {
...
function TruncatedCell({ children }) {
    ...
    React.createElement(tooltip_1.Tooltip, { content: state.text, hidden: !state.overflow, className: "max-w-[360px] break-words" },
