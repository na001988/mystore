...
exports.DataTableSortableHeaderCell = React.forwardRef(({ id, children, className, style: propStyle, isFirstColumn, ...props }, ref) => {
    ...
    const style = {
        ...
        transform: transformStyle
            ? utilities_1.CSS.Transform.toString(transformStyle)
            : undefined,
        transition,
    ...
    return (React.createElement(table_1.Table.HeaderCell, { ref: combineRefs, style: style, className: (0, clx_1.clx)(className, "group/header-cell bg-ui-bg-subtle", {
            "bg-ui-bg-base border-ui-border-interactive shadow-elevation-flyout": isDragging,
