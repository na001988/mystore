...
const DataTableToolbar = (props) => {
    ...
    return (React.createElement("div", { className: "flex flex-col divide-y" },
        ...
        React.createElement(data_table_filter_bar_1.DataTableFilterBar, { clearAllFiltersLabel: (_a = props.translations) === null || _a === void 0 ? void 0 : _a.clearAll, alwaysShow: props.alwaysShowFilterBar }, props.filterBarContent)));
};
