        ...
        if (!__classPrivateFieldGet(this, _IndexModuleService_isWorkerMode, "f")) {
            await this.baseRepository_.transaction(async (transactionManager) => {
                ...
                const truncableTables = [
                    (0, utils_1.toMikroORMEntity)(_models_1.IndexData),
                    (0, utils_1.toMikroORMEntity)(_models_1.IndexRelation),
                    (0, utils_1.toMikroORMEntity)(_models_1.IndexMetadata),
                    (0, utils_1.toMikroORMEntity)(_models_1.IndexSync),
