                        ...
                        if (operator) {
                            ...
                            if (operator === "=") {
                                ...
                                if (hasId) {
                                    ...
                                    builder.whereRaw(`${aliasMapping[attr]}.data @> ?::jsonb`, [getPathOperation(attr, field, subValue)]);
                                }
                            }
                ...
                if (Array.isArray(value)) {
                    ...
                    if (operator === "=") {
                        ...
                        if (hasId) {
                            ...
                            builder.whereRaw(`${aliasMapping[attr]}.data @> ?::jsonb`, [getPathOperation(attr, field, value)]);
                        }
                    }
                    else {
                        if (value === null) {
