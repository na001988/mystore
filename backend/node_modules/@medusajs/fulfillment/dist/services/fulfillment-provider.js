...
Please make sure that the provider is registered in the container and it is configured correctly in your project configuration file.`;
    ...
    async createFulfillment(providerId, data, items, order, fulfillment, additionalData) {
        const provider = this.retrieveProviderRegistration(providerId);
        return await provider.createFulfillment(data, items, order, fulfillment, additionalData);
    }
