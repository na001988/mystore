...
export default class FulfillmentProviderService extends FulfillmentProviderService_base {
    ...
    createFulfillment(providerId: string, data: Record<string, unknown>, items: Partial<Omit<FulfillmentItemDTO, "fulfillment">>[], order: Partial<FulfillmentOrderDTO> | undefined, fulfillment: Partial<Omit<FulfillmentDTO, "provider_id" | "data" | "items">>, additionalData?: Record<string, unknown>): Promise<CreateFulfillmentResult>;
