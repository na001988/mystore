...
exports.Migration20251022153442 = void 0;
const migrations_1 = require("@mikro-orm/migrations");
class Migration20251022153442 extends migrations_1.Migration {
    async up() {
        this.addSql(`
    ...
    `);
        ...
        this.addSql(`alter table if exists "product_option" drop column if exists "product_id";`);
    }
    async down() {
...
exports.Migration20251022153442 = Migration20251022153442;
//# sourceMappingURL=Migration20251022153442.js.map