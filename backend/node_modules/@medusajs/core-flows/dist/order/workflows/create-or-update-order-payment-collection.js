...
exports.createOrUpdateOrderPaymentCollectionWorkflow = exports.createOrUpdateOrderPaymentCollectionWorkflowId = exports.getOrderPendingAmountStep = void 0;
 ...
 */
exports.getOrderPendingAmountStep = (0, workflows_sdk_1.createStep)("get-order-pending-amount", async ({ order, input }) => {
    ...
    return new workflows_sdk_1.StepResponse(amountPending);
});
...
exports.createOrUpdateOrderPaymentCollectionWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.createOrUpdateOrderPaymentCollectionWorkflowId, (input) => {
    ...
    const shouldRecreate = (0, workflows_sdk_1.transform)({ existingPaymentCollection }, ({ existingPaymentCollection }) => existingPaymentCollection?.status ===
        ...
        existingPaymentCollection?.status ===
            utils_1.PaymentCollectionStatus.PARTIALLY_AUTHORIZED);
    const amountPending = (0, exports.getOrderPendingAmountStep)({ order, input });
