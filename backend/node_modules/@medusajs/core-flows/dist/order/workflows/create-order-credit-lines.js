...
exports.createOrderCreditLinesWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.createOrderCreditLinesWorkflowId, (input) => {
    ...
    const createdCreditLines = (0, workflows_sdk_1.transform)({ confirmedOrderChanges: orderChanges, orderChange }, ({ confirmedOrderChanges, orderChange }) => {
        return confirmedOrderChanges.credit_lines.filter((creditLine) => creditLine.metadata?.created_in_version === orderChange.version);
    });
