...
exports.refundCapturedPaymentsWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.refundCapturedPaymentsWorkflowId, (input) => {
    ...
    const refundedPayments = (0, workflows_sdk_1.when)({ totalCaptured }, ({ totalCaptured }) => {
        return !!utils_1.MathBN.gt(totalCaptured, 0);
    }).then(() => {
        return refund_payments_1.refundPaymentsWorkflow.runAsStep({ input: refundPaymentsData });
    });
    const response = (0, workflows_sdk_1.transform)({ refundedPayments }, ({ refundedPayments }) => refundedPayments ?? []);
