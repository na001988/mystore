...
exports.createOrderFulfillmentWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.createOrderFulfillmentWorkflowId, (input) => {
    ...
    const { levelUpdatedEvents, reservationUpdatedEvents, reservationDeletedEvents, } = (0, workflows_sdk_1.transform)({ adjustedLevels, toUpdate, toDelete, input }, ({ adjustedLevels, toUpdate, toDelete, input }) => {
        return {
    ...
    }).config({ name: "emit-reservation-item-updated" }), (0, common_1.emitEventStep)({
        eventName: utils_1.ReservationItemWorkflowEvents.DELETED,
