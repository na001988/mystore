...
exports.confirmReturnReceiveWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.confirmReturnReceiveWorkflowId, function (input) {
    ...
    const [, , , adjustedLevels] = (0, workflows_sdk_1.parallelize)((0, steps_2.updateReturnsStep)([updateReturn]), (0, steps_2.updateReturnItemsStep)(updateReturnItem), (0, confirm_order_changes_1.confirmOrderChanges)({
        changes: [orderChange],
        orderId: order.id,
        confirmed_by: input.confirmed_by,
    }), (0, steps_1.adjustInventoryLevelsStep)(inventoryAdjustment));
    const levelUpdatedEvents = (0, workflows_sdk_1.transform)({ adjustedLevels, order }, ({ adjustedLevels, order }) => {
