...
exports.cancelOrderFulfillmentWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.cancelOrderFulfillmentWorkflowId, (input) => {
    ...
    const adjustedLevels = (0, inventory_1.adjustInventoryLevelsStep)(inventoryAdjustment);
    ...
    const [, createdReservations] = (0, workflows_sdk_1.parallelize)((0, cancel_fulfillment_1.cancelOrderFulfillmentStep)(cancelOrderFulfillmentData), (0, reservation_1.createReservationsStep)(toCreate), (0, reservation_1.updateReservationsStep)(toUpdate), (0, common_1.emitEventStep)({
        eventName: utils_1.OrderWorkflowEvents.FULFILLMENT_CANCELED,
        data: eventData,
    }));
    const { levelUpdatedEvents, reservationCreatedEvents, reservationUpdatedEvents, } = (0, workflows_sdk_1.transform)({ adjustedLevels, createdReservations, toUpdate, order }, ({ adjustedLevels, createdReservations, toUpdate, order }) => {
        return {
    ...
    (0, workflows_sdk_1.parallelize)((0, common_1.emitEventStep)({
        eventName: utils_1.InventoryLevelWorkflowEvents.UPDATED,
        data: levelUpdatedEvents,
    }).config({ name: "emit-inventory-level-updated" }), (0, common_1.emitEventStep)({
        eventName: utils_1.ReservationItemWorkflowEvents.CREATED,
        data: reservationCreatedEvents,
    }).config({ name: "emit-reservation-item-created" }), (0, common_1.emitEventStep)({
        eventName: utils_1.ReservationItemWorkflowEvents.UPDATED,
