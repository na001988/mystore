...
exports.cancelOrderClaimWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.cancelOrderClaimWorkflowId, (input) => {
    ...
    const [, deletedReservationIds] = (0, workflows_sdk_1.parallelize)((0, steps_1.cancelOrderClaimStep)({
    ...
    const reservationDeletedEvents = (0, workflows_sdk_1.transform)({ deletedReservationIds, orderClaim }, ({ deletedReservationIds, orderClaim }) => {
