...
exports.confirmOrderEditRequestWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.confirmOrderEditRequestWorkflowId, function (input) {
    ...
    const deletedReservationIds = (0, reservation_1.deleteReservationsByLineItemsStep)(toRemoveReservationLineItemIds);
    const createdReservations = (0, reserve_inventory_1.reserveInventoryStep)(formatedInventoryItems);
    const { reservationDeletedEvents, reservationCreatedEvents } = (0, workflows_sdk_1.transform)({ deletedReservationIds, createdReservations, order }, ({ deletedReservationIds, createdReservations, order }) => {
        return {
    ...
    }).config({ name: "emit-reservation-item-deleted" }), (0, common_1.emitEventStep)({
