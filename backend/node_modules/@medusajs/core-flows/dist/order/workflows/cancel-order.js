...
exports.cancelOrderWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.cancelOrderWorkflowId, (input) => {
    ...
    const [refundedPayments, deletedReservationIds] = (0, workflows_sdk_1.parallelize)(refund_captured_payments_1.refundCapturedPaymentsWorkflow.runAsStep({
    ...
    const reservationDeletedEvents = (0, workflows_sdk_1.transform)({ deletedReservationIds, order }, ({ deletedReservationIds, order }) => {
