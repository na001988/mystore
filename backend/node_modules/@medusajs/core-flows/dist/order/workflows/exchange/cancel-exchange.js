...
exports.cancelOrderExchangeWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.cancelOrderExchangeWorkflowId, (input) => {
    ...
    const [, deletedReservationIds] = (0, workflows_sdk_1.parallelize)((0, steps_1.cancelOrderExchangeStep)({
    ...
    const reservationDeletedEvents = (0, workflows_sdk_1.transform)({ deletedReservationIds, orderExchange }, ({ deletedReservationIds, orderExchange }) => {
