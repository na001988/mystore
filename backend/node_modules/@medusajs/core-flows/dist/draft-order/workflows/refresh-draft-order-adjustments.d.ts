 ...
 */
export declare const refreshDraftOrderAdjustmentsWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<RefreshDraftOrderAdjustmentsWorkflowInput, undefined, [import("@medusajs/framework/workflows-sdk").Hook<"setPromotionContext", {
    order: OrderDTO;
    promo_codes: string[];
    action: PromotionActions;
