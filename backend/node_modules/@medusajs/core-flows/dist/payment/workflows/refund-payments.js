...
exports.validatePaymentsRefundStep = (0, workflows_sdk_1.createStep)("validate-payments-refund-step", async function ({ payments, input }) {
    ...
    for (const payment of payments) {
        ...
        const refundedAmount = (payment.refunds || []).reduce((refundAmount, next) => {
            const amountAsBigNumber = new utils_1.BigNumber(next.raw_amount);
            return utils_1.MathBN.add(refundAmount, amountAsBigNumber);
        }, utils_1.MathBN.convert(0));
        const amountToRefund = paymentIdAmountMap.get(payment.id);
        const totalRefundedAmount = utils_1.MathBN.add(refundedAmount, amountToRefund);
