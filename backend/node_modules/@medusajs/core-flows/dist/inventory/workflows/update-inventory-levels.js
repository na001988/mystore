...
exports.updateInventoryLevelsWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.updateInventoryLevelsWorkflowId, (input) => {
    const inventoryLevels = (0, update_inventory_levels_1.updateInventoryLevelsStep)(input.updates);
    const levelIdEvents = (0, workflows_sdk_1.transform)({ inventoryLevels }, ({ inventoryLevels }) => {
    ...
    return new workflows_sdk_1.WorkflowResponse(inventoryLevels);
});
