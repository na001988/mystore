...
exports.updateInventoryItemsWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.updateInventoryItemsWorkflowId, (input) => {
    const updatedItems = (0, steps_1.updateInventoryItemsStep)(input.updates);
    const itemIdEvents = (0, workflows_sdk_1.transform)({ updatedItems }, ({ updatedItems }) => {
        return updatedItems.map((item) => ({ id: item.id }));
    });
    (0, common_1.emitEventStep)({
        eventName: utils_1.InventoryItemWorkflowEvents.UPDATED,
        data: itemIdEvents,
    });
    return new workflows_sdk_1.WorkflowResponse(updatedItems);
});
