 ...
 */
export declare const deleteReservationsByLineItemsStep: import("@medusajs/framework/workflows-sdk").StepFunction<DeleteReservationsByLineItemsStepInput, string[]>;
