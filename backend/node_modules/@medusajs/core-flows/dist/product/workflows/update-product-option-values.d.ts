...
export declare const updateProductOptionValuesWorkflowId = "update-product-option-values";
/**
 ...
 */
export declare const updateProductOptionValuesWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<UpdateProductOptionValuesWorkflowInput, ProductTypes.ProductOptionValueDTO, []>;
//# sourceMappingURL=update-product-option-values.d.ts.map