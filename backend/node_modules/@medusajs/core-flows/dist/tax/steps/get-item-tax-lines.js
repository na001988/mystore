...
function normalizeTaxModuleContext(orderOrCart, forceTaxCalculation, isReturn, shippingAddress, additionalContext) {
...
exports.getItemTaxLinesStep = (0, workflows_sdk_1.createStep)(exports.getItemTaxLinesStepId, async (data, { container }) => {
    const { orderOrCart, items = [], shipping_methods: shippingMethods = [], force_tax_calculation: forceTaxCalculation = false, is_return: isReturn = false, shipping_address: shippingAddress, additional_context: additionalContext, } = data;
    ...
    const taxContext = normalizeTaxModuleContext(orderOrCart, forceTaxCalculation, isReturn, shippingAddress, additionalContext);
