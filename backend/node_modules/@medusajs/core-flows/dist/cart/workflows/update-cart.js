...
exports.updateCartWorkflow = (0, workflows_sdk_1.createWorkflow)({
    ...
    const taxRelevantAddressChanged = (0, workflows_sdk_1.transform)({ input, cartToUpdate }, ({ input, cartToUpdate }) => {
        ...
        const changed = (nextValue, prevValue) => nextValue !== undefined && nextValue !== prevValue;
        ...
        return (changed(nextId, prev?.id) ||
            changed(next.country_code?.toLowerCase(), prev?.country_code?.toLowerCase()) ||
    ...
    */
    ...
    const refreshCartItemsInput = (0, workflows_sdk_1.transform)({ cartInput, input, newRegion, newLocaleCode, taxRelevantAddressChanged }, ({ cartInput, input, newRegion, newLocaleCode, taxRelevantAddressChanged, }) => {
        return {
            cart_id: cartInput.id,
            promo_codes: input.promo_codes,
            force_refresh: !!newRegion || !!newLocaleCode || taxRelevantAddressChanged,
