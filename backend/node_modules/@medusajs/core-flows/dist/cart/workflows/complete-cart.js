...
exports.completeCartWorkflow = (0, workflows_sdk_1.createWorkflow)({
    ...
    const order = (0, workflows_sdk_1.when)("create-order", { orderId }, ({ orderId }) => {
        ...
        const [, , createdReservations] = (0, workflows_sdk_1.parallelize)((0, common_1.createRemoteLinkStep)(linksToCreate), (0, steps_1.updateCartsStep)([updateCompletedAt]), (0, reserve_inventory_1.reserveInventoryStep)(formatedInventoryItems), (0, register_usage_1.registerUsageStep)(promotionUsage), (0, common_1.emitEventStep)({
        ...
        const reservationCreatedEvents = (0, workflows_sdk_1.transform)({ createdReservations, createdOrder }, ({ createdReservations, createdOrder }) => {
