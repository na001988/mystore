...
exports.addToCartWorkflow = (0, workflows_sdk_1.createWorkflow)({
    ...
    const { variants: variantsData, lineItems: lineItemsData } = (0, workflows_sdk_1.when)("should-calculate-prices", { variantIds }, ({ variantIds }) => {
        ...
        const pricingQuantities = (0, steps_1.getLineItemPricingQuantitiesStep)({
            id: input.cart_id,
            items: input.items,
        });
        const itemsToPrice = (0, workflows_sdk_1.transform)({ items: input.items, pricingQuantities }, ({ items, pricingQuantities }) => {
        ...
        const lineItems = (0, workflows_sdk_1.transform)({ items, originalItems: input.items }, ({ items, originalItems }) => {
            return items.map((item, index) => {
    ...
    const fetchedVariants = (0, workflows_sdk_1.when)("fetch-variants", { variantsData, variantIds }, ({ variantsData, variantIds }) => {
        ...
        return (0, common_1.useQueryGraphStep)({
            ...
            options: {
                cache: {
                    tags: fields_1.productVariantsCacheTags,
