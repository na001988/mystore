...
exports.listShippingOptionsForCartWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.listShippingOptionsForCartWorkflowId, (input) => {
    ...
    const scFulfillmentSetQuery = (0, common_1.useQueryGraphStep)({
        ...
        options: {
            cache: {
                tags: fields_1.salesChannelStockLocationCacheTags,
    ...
    const queryVariables = (0, workflows_sdk_1.transform)({
        ...
        return {
            ...
            calculated_price: {
                context: {
                    ...(0, utils_1.filterObjectByKeys)(cart, fields_2.cartFieldsForPricingContext),
