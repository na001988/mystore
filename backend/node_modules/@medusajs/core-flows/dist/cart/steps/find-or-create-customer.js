...
async function fetchCustomerById(customerId, container) {
    ...
    return await (0, utils_1.useCache)(async () => service.retrieveCustomer(customerId, { relations: ["groups"] }), {
        container,
...
async function fetchCustomersByEmail(email, container, hasAccount) {
    ...
    return await (0, utils_1.useCache)(async () => service.listCustomers(filters, { relations: ["groups"] }), {
        container,
