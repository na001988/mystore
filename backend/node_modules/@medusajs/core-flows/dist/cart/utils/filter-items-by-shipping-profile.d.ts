 ...
 */
export declare const filterCartItemsByShippingProfile: <T extends ItemWithShippingProfile>(items: T[] | undefined | null, shippingProfileId: string | undefined | null) => T[];
export {};
//# sourceMappingURL=filter-items-by-shipping-profile.d.ts.map