...
exports.batchLinksWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.batchLinksWorkflowId, (input) => {
    const { create, update, delete: deleteLinks } = (0, workflows_sdk_1.transform)({ input }, (data) => {
        return {
    ...
    const [created, updated, deleted] = (0, workflows_sdk_1.parallelize)((0, create_remote_links_1.createRemoteLinkStep)(create), (0, update_remote_links_1.updateRemoteLinksStep)(update), (0, dismiss_remote_links_1.dismissRemoteLinkStep)(deleteLinks));
