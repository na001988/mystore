...
export declare const batchLinksWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<BatchWorkflowInput<LinkDefinition, LinkDefinition, LinkDefinition>, {
    created: LinkDefinition[] & import("@medusajs/framework/workflows-sdk").WorkflowDataProperties<LinkDefinition[]> & {
        config(config: {
            name?: string;
    ...
    updated: LinkDefinition[] & import("@medusajs/framework/workflows-sdk").WorkflowDataProperties<LinkDefinition[]> & {
        config(config: {
            name?: string;
        } & Omit<import("@medusajs/orchestration").TransactionStepsDefinition, "next" | "uuid" | "action">): WorkflowData<LinkDefinition[]>;
    } & import("@medusajs/framework/workflows-sdk").StepFunctionReturnConfig<LinkDefinition[]>;
    deleted: LinkDefinition[] & import("@medusajs/framework/workflows-sdk").WorkflowDataProperties<LinkDefinition[]> & {
        config(config: {
            name?: string;
        } & Omit<import("@medusajs/orchestration").TransactionStepsDefinition, "next" | "uuid" | "action">): WorkflowData<LinkDefinition[]>;
    } & import("@medusajs/framework/workflows-sdk").StepFunctionReturnConfig<LinkDefinition[]>;
