  ...
  return /* @__PURE__ */ jsxs(Container, { className: "flex items-center justify-between gap-4", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-x-2", children: [
        ...
        isRegionLoaded ? /* @__PURE__ */ jsx(Badge, { size: "2xsmall", rounded: "full", asChild: true, children: /* @__PURE__ */ jsx(Link, { to: `/settings/regions/${region?.id}`, children: region?.name }) }) : /* @__PURE__ */ jsx(Skeleton, { className: "w-14 h-5 rounded-full" })
      ] }),
      ...
      /* @__PURE__ */ jsx("div", { className: "flex items-center px-6 py-4 justify-between gap-x-3", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-x-3 max-sm:items-start", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-[5px] max-sm:flex-col max-sm:items-start flex-1 w-full overflow-hidden", children: [
          /* @__PURE__ */ jsx(
            Tooltip,
            {
              content: /* @__PURE__ */ jsx("ul", { children: profile.items.map((item) => /* @__PURE__ */ jsx(
                "li",
                {
              ...
              children: /* @__PURE__ */ jsxs(
                Badge,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "truncate", children: shippingOption.service_zone?.fulfillment_set?.location?.name })
                  ]
                }
              )
            }
          ...
          /* @__PURE__ */ jsx("div", { className: "flex flex-1 flex-col items-center overflow-y-auto", children: /* @__PURE__ */ jsxs("div", { className: "flex w-full max-w-[720px] flex-col gap-y-6 px-6 py-16", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-6", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "bg-ui-bg-subtle shadow-elevation-card-rest rounded-xl", children: [
                ...
                ] }) : matches.length > 0 ? matches?.map((item) => /* @__PURE__ */ jsx(
                  Item,
                  {
                    item,
                    preview,
      ...
      columnHelper.accessor("product.title", {
        ...
        cell: ({ row }) => {
          return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-x-2", children: [
            ...
            /* @__PURE__ */ jsx("span", { children: row.original.product?.title })
          ] });
        },
        enableSorting: true
      }),
...
const Metadata = () => {
  ...
  return /* @__PURE__ */ jsxs(RouteDrawer, { children: [
    ...
    !isReady ? /* @__PURE__ */ jsx(PlaceholderInner, {}) : /* @__PURE__ */ jsx(MetadataForm, { orderId: id, metadata: order?.metadata })
  ] });
};
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex w-full items-center gap-x-3 overflow-hidden", children: [
                      ...
                      !shippingOption ? /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-x-3", children: [
                        ...
                        /* @__PURE__ */ jsx(
                          Tooltip,
                          {
                            content: /* @__PURE__ */ jsx("ul", { children: items.map((item) => /* @__PURE__ */ jsx(
                              "li",
                              {
                                children: `${item.quantity}x ${item.variant?.product?.title} (${item.variant?.title})`
                              },
...
const ItemsPreview = ({ order, shippingProfileId }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-6", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-ui-bg-subtle shadow-elevation-card-rest rounded-xl", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-y-1.5 px-[5px] pb-[5px]", children: matches.length > 0 ? matches?.map((item) => /* @__PURE__ */ jsxs(
        "div",
        {
