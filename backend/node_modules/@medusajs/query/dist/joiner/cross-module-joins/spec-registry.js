...
exports.registerCandidates = registerCandidates;
/**
 ...
 */
function registerCandidates(registry, candidates) {
    const additions = {};
    const usedTables = new Set(Object.values(registry).map((spec) => spec.target.table));
