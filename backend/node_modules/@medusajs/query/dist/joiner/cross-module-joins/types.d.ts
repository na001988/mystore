import { CrossModuleJoinSpec, JoinerRelationship, JoinerServiceConfigAlias } from "@medusajs/types";
import { InternalJoinerServiceConfig } from "../types";
export type InternalRelationMetadata = NonNullable<NonNullable<JoinerServiceConfigAlias["__internal"]>["relations"]>[string];
/**
