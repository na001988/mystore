import { CrossModuleJoinSpec, JoinerArgument, JoinerRelationship, JoinerServiceConfig, ModuleJoinerConfig, RemoteJoinerOptions, RemoteJoinerQuery } from "@medusajs/types";
export declare const BASE_PATH = "_root";
...
export interface IRemoteDataFetcher {
    fetch(expand: RemoteExpandProperty, keyField: string, ids?: (unknown | unknown[])[], relationship?: JoinerRelationship): Promise<{
        data: unknown[] | {
            [path: string]: unknown;
        };
        path?: string;
