...
import { AdminProduct, AdminProductOption, AdminProductOptionValue, AdminProductVariant, AdminProductVariantInventoryLink } from "./entitites";
...
export interface AdminProductOptionValueDeleteResponse extends DeleteResponseWithParent<"product_option_value", AdminProductOption> {
}
