...
import { ViewConfigurationDTO, UserPreferenceDTO, PropertyLabelDTO, LayoutConfigurationDTO, LayoutConfigurationData, FilterableViewConfigurationProps, FilterableUserPreferenceProps, FilterableLayoutConfigurationProps, PropertyLabelFilterableFields } from "./common";
import { CreateViewConfigurationDTO, UpdateViewConfigurationDTO, CreateLayoutConfigurationDTO, CreatePropertyLabelDTO, UpdatePropertyLabelDTO, UpsertPropertyLabelDTO } from "./mutations";
/**
...
export interface ISettingsModuleService extends IModuleService {
     ...
     * ```
     */
    retrieveLayoutConfiguration(id: string, config?: FindConfig<LayoutConfigurationDTO>, sharedContext?: Context): Promise<LayoutConfigurationDTO>;
    /**
     ...
     * ```
     */
    listLayoutConfigurations(filters?: FilterableLayoutConfigurationProps, config?: FindConfig<LayoutConfigurationDTO>, sharedContext?: Context): Promise<LayoutConfigurationDTO[]>;
    /**
     ...
     * ```
     */
    listAndCountLayoutConfigurations(filters?: FilterableLayoutConfigurationProps, config?: FindConfig<LayoutConfigurationDTO>, sharedContext?: Context): Promise<[LayoutConfigurationDTO[], number]>;
    /**
     ...
     *   ])
     */
    createLayoutConfigurations(data: CreateLayoutConfigurationDTO[], sharedContext?: Context): Promise<LayoutConfigurationDTO[]>;
    /**
     ...
     */
    deleteLayoutConfigurations(ids: string | string[], sharedContext?: Context): Promise<void>;
    /**
     ...
     *   )
     */
    getSystemDefaultLayoutConfiguration(zone: string, sharedContext?: Context): Promise<LayoutConfigurationDTO | null>;
    /**
     ...
     *   )
     */
    setLayoutConfiguration(zone: string, userId: string, data: LayoutConfigurationData, sharedContext?: Context): Promise<LayoutConfigurationDTO>;
    /**
     ...
     *   )
     */
    setSystemDefaultLayoutConfiguration(zone: string, data: LayoutConfigurationData, sharedContext?: Context): Promise<LayoutConfigurationDTO>;
    /**
     ...
     * )
     */
    clearLayoutConfiguration(zone: string, userId: string, sharedContext?: Context): Promise<void>;
    /**
     ...
     * )
     */
    getActiveLayoutScope(zone: string, userId: string, sharedContext?: Context): Promise<"personal" | "default" | null>;
    /**
     ...
     * )
     */
    setActiveLayoutScope(zone: string, userId: string, scope: "personal" | "default" | null, sharedContext?: Context): Promise<void>;
    /**
