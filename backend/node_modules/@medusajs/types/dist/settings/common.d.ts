 ...
 */
export interface FilterableLayoutConfigurationProps extends LayoutConfigurationFilterableFields {
    /**
     * An array of filters to apply on the entity, where each item in the array is joined with an "and" condition.
     */
    $and?: (LayoutConfigurationFilterableFields | FilterableLayoutConfigurationProps)[];
    /**
     * An array of filters to apply on the entity, where each item in the array is joined with an "or" condition.
     */
    $or?: (LayoutConfigurationFilterableFields | FilterableLayoutConfigurationProps)[];
}
/**
