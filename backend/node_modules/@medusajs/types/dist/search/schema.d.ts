 ...
 */
export type InferSearchDocumentType<Fields extends SearchIndexFieldsInput> = Fields extends {
    schema: infer Schema extends SearchSchema;
} ? InferSearchObjectValue<Schema> & {
    id: string;
} : SearchDocument;
/**
 ...
 */
export type SearchIndexFieldsInput = Record<string, SearchFieldDefinition> | SearchFieldsSchemaLike;
/**
 ...
 * declared schema.
 */
export type SearchIndexDefinitionInput<Fields extends SearchIndexFieldsInput = SearchIndexFieldsInput> = Omit<SearchIndexDefinition, "fields" | "seed"> & {
    fields: Fields;
    seed: (context: SearchSeedContext) => AsyncIterable<InferSearchDocumentType<Fields>[]>;
};
