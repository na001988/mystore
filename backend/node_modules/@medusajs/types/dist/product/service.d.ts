...
export interface IProductModuleService extends IModuleService {
     ...
     *   })
     */
    addProductOptionToProduct(productOptionProductPair: ProductOptionProductPair, sharedContext?: Context): Promise<{
        /**
     ...
     *   ])
     */
    addProductOptionToProduct(productOptionProductPairs: ProductOptionProductPair[], sharedContext?: Context): Promise<{
        /**
         * The ID of the relation between the product option and the product.
         */
        id: string;
     ...
     * })
     */
    removeProductOptionFromProduct(productOptionProductPair: ProductOptionProductPair, sharedContext?: Context): Promise<string[]>;
    /**
     ...
     * ])
     */
    removeProductOptionFromProduct(productOptionProductPairs: ProductOptionProductPair[], sharedContext?: Context): Promise<string[]>;
    /**
     ...
     * })
     */
    updateProductOptionValuesOnProduct(update: ProductOptionProductValueUpdate, sharedContext?: Context): Promise<void>;
    /**
     ...
     * ])
     */
    updateProductOptionValuesOnProduct(updates: ProductOptionProductValueUpdate[], sharedContext?: Context): Promise<void>;
    /**
