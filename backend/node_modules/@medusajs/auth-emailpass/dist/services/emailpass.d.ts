import { AuthenticationInput, AuthenticationResponse, AuthIdentityDTO, AuthIdentityProviderService, EmailPassAuthProviderOptions, Logger } from "@medusajs/framework/types";
...
export declare class EmailPassAuthService extends AbstractAuthModuleProvider {
    ...
    private getProviderMetadata_;
    private sanitizeAuthIdentity_;
    private getProviderIdentity_;
}
export {};
