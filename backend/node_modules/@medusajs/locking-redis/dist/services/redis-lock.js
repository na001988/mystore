...
class RedisLockingProvider {
    constructor({ redisClient, prefix }, options) {
        ...
        this.defaultRetryInterval = 20;
        this.maximumRetryInterval = 1000;
            ...
            const acquireLock = async () => {
                while (true) {
                    if (cancellationToken?.cancelled) {
                        throw new utils_1.MedusaError(utils_1.MedusaError.Types.CONFLICT, errMessage);
                    }
                    ...
                    if (result === 1) {
                        ...
                        if (awaitQueue) {
                            ...
                            await (0, promises_1.setTimeout)(jitteredDelay);
    ...
    async getTimeout(seconds, cancellationToken) {
        return new Promise(async (_, reject) => {
            ...
            reject(new utils_1.MedusaError(utils_1.MedusaError.Types.CONFLICT, "Timed-out acquiring lock."));
        });
    }
}
