...
// src/hooks/api/search.tsx
import {
  useQuery as useQuery11,
  keepPreviousData
} from "@tanstack/react-query";
var SEARCH_QUERY_KEY = "search";
var searchQueryKeys = queryKeysFactory(SEARCH_QUERY_KEY);
var useAdminSearch = (query, options) => {
  const { data, ...rest } = useQuery11({
