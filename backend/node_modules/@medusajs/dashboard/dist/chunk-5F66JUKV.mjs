...
var getPromotionStatus = (promotion) => {
  ...
  const isPerAttributeBudget = campaignBudget?.type === "use_by_attribute" || campaignBudget?.type === "spend_by_attribute";
  const overBudget = campaignBudget && !isPerAttributeBudget && campaignBudget.limit && campaignBudget.used > campaignBudget.limit;
