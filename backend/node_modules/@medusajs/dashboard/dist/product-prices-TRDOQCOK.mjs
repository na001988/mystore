    ...
    return [
      columnHelper.column({
        ...
        cell: (context) => {
          ...
          return /* @__PURE__ */ jsx(DataGrid.ReadonlyCell, { context, children: /* @__PURE__ */ jsx("div", { className: "flex h-full w-full items-center gap-x-2 overflow-hidden", children: /* @__PURE__ */ jsx(Tooltip, { content: entity.title, children: /* @__PURE__ */ jsx("span", { className: "truncate", children: entity.title }) }) }) });
        },
        disableHiding: true
      }),
      ...createDataGridPriceColumns({
