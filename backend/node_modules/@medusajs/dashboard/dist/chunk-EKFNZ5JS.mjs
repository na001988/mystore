                        ...
                        /* @__PURE__ */ jsxs7(
                          "div",
                          {
                            ...
                            children: [
                              ...
                              header.column.getCanResize() && /* @__PURE__ */ jsx10(
                                "div",
                                {
    ...
    ...currencies2?.map((currency) => {
      ...
      return columnHelper.column({
        ...
        cell: (context) => {
          ...
          return renderPriceCell ? renderPriceCell(currency, context) : /* @__PURE__ */ jsx15(DataGridCurrencyCell, { code: currency, context });
        }
      });
    }) ?? [],
    ...regions?.map((region) => {
      ...
      return columnHelper.column({
        ...
        cell: (context) => {
          ...
          return renderPriceCell ? renderPriceCell(region.currency_code, context) : /* @__PURE__ */ jsx15(
