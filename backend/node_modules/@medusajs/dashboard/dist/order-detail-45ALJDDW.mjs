...
import {
  ...
  useClaims
} from "./chunk-FMY74UCS.mjs";
import {
  useCancelExchange,
  useCancelExchangeRequest,
  useExchanges
} from "./chunk-FSTMNVI6.mjs";
import {
...
var seo = (match) => ({
  title: match.loaderData?.order ? `#${match.loaderData.order.display_id}` : void 0
});
