...
export default class CartModuleService extends CartModuleService_base implements ICartModuleService {
    ...
    protected updateCarts_(dataOrIdOrSelector: CartTypes.UpdateCartDTO[] | string | Partial<CartTypes.CartDTO>, data?: CartTypes.UpdateCartDataDTO, sharedContext?: Context): Promise<{
        ...
        items: {
            ...
            variant_option_values: NoInfer<Record<string, unknown>> | null;
        ...
        credit_lines: {
            ...
            amount: number;
            raw_amount: NoInfer<Record<string, unknown>> & Record<string, unknown>;
            metadata: NoInfer<Record<string, unknown>> | null;
            created_at: Date;
            updated_at: Date;
            deleted_at: Date | null;
        ...
        shipping_methods: {
            id: string;
            name: string;
            description: NoInfer<Record<string, unknown>> | null;
            amount: number;
            is_tax_inclusive: boolean;
