 ...
 */
function isMedusaEslintPluginInstalled(cwd) {
    try {
 ...
 * the describe text.
 */
function addLintOptions(builder, commandLabel, directory) {
...
function buildLocalCommands(cli, isLocalProject) {
    ...
    cli
        ...
        handler: handlerP(getCommandHandler("db/migrate-search", (args, cmd) => {
            process.env.NODE_ENV = process.env.NODE_ENV || `development`;
            return cmd(args);
        })),
    })
        ...
        }), "starting the dev server", directory),
        ...
        }), "building", directory).option("quiet", {
            type: "boolean",
            default: false,
