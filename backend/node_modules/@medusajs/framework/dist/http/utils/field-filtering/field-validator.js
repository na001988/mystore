...
exports.DisallowedFieldFilter = exports.RestrictedFieldFilter = exports.AllowedFieldFilter = void 0;
/**
...
class DisallowedFieldFilter {
    ...
    getNotAllowedFields(context) {
        ...
        return fieldsToCheck.filter((field) => {
            const fieldSegments = field.split(".");
            return this.disallowed.some((disallowedField) => fieldSegments.includes(disallowedField));
        });
    }
}
exports.DisallowedFieldFilter = DisallowedFieldFilter;
