...
class JobLoader extends resource_loader_1.ResourceLoader {
    ...
    register({ path, config, handler, }) {
        ...
        const step = (0, workflows_sdk_1.createStep)(`${config.name}-as-step`, async (input, stepContext) => {
        ...
        (0, workflows_sdk_1.createWorkflow)(workflowConfig, (input) => {
            return new workflows_sdk_1.WorkflowResponse(step(input));
        });
