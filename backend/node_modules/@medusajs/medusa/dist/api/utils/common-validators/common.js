...
exports.booleanString = exports.applyAndAndOrOperators = exports.BigNumberInput = exports.safeHttpUrl = exports.AddressPayload = void 0;
 ...
 */
exports.safeHttpUrl = zod_1.z.string().refine((value) => {
    if (value === "" || value === "#") {
        return true;
    }
    try {
