...
exports.StoreGetProductParamsDirectFields = zod_1.z.object({
    ...
    option_id: zod_1.z.union([zod_1.z.string(), zod_1.z.array(zod_1.z.string())]).optional(),
    option_value_id: zod_1.z.union([zod_1.z.string(), zod_1.z.array(zod_1.z.string())]).optional(),
...
const transformProductParams = (data) => {
    ...
    if ((0, utils_1.isPresent)(data.option_id)) {
        res.options = { id: data.option_id };
        delete res.option_id;
    }
    if ((0, utils_1.isPresent)(data.option_value_id)) {
        res.option_value_id = data.option_value_id;
    }
    return res;
};
