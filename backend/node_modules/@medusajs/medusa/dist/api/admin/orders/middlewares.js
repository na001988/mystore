...
exports.adminOrderRoutesMiddlewares = [
    ...
    },
    {
        ...
        middlewares: [
            (0, framework_1.validateAndTransformBody)(validators_1.AdminAuthorizeOrderPaymentSession),
            (0, framework_1.validateAndTransformQuery)(validators_1.AdminGetOrdersOrderParams, QueryConfig.retrieveTransformQueryConfig),
        ],
        policies: [
            {
    ...
    },
    {
        ...
        middlewares: [
            (0, framework_1.validateAndTransformBody)(validators_1.AdminTransferOrderToGuest),
            (0, framework_1.validateAndTransformQuery)(validators_1.AdminGetOrdersOrderParams, QueryConfig.retrieveTransformQueryConfig),
        ],
        policies: [
            {
