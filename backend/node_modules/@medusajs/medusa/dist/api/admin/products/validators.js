...
exports.AdminGetProductsParamsDirectFields = zod_1.z.object({
    variants: validators_3.AdminGetProductVariantsParamsFields.omit({ q: true })
        .merge((0, common_validators_1.applyAndAndOrOperators)(validators_3.AdminGetProductVariantsParamsFields.omit({ q: true })))
        .optional(),
...
exports.AdminLinkProductOptionWithValues = zod_1.z.object({
    id: zod_1.z.string(),
    value_ids: zod_1.z.array(zod_1.z.string()),
});
exports.AdminUpdateProductOptionValues = zod_1.z.object({
    product_option_id: zod_1.z.string(),
    add: zod_1.z
        .array(zod_1.z.union([
        zod_1.z.string(),
        zod_1.z
...
exports.AdminLinkProductOptions = zod_1.z.object({
    add: zod_1.z
        .array(zod_1.z.union([
        zod_1.z.string(),
        validators_2.AdminCreateProductOption,
        exports.AdminLinkProductOptionWithValues,
    ]))
        .optional(),
    remove: zod_1.z.array(zod_1.z.string()).optional(),
    update: zod_1.z.array(exports.AdminUpdateProductOptionValues).optional(),
});
...
exports.CreateProduct = zod_1.z
    ...
    options: zod_1.z
        ...
        zod_1.z.object({
            id: zod_1.z.string(),
            value_ids: zod_1.z.array(zod_1.z.string()).optional(),
        }),
    ]))
        .optional(),
...
exports.UpdateProduct = zod_1.z
    ...
    options: zod_1.z.any().superRefine((val, ctx) => {
        if (val !== undefined) {
            ctx.addIssue({
                code: zod_1.z.ZodIssueCode.custom,
                message: "The 'options' property was removed in version 2.16.0. Please remove it from your request payload.",
            });
        }
    }),
    option_ids: zod_1.z.array(zod_1.z.string()).optional(),
