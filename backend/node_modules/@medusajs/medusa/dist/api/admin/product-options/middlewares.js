...
exports.adminProductOptionRoutesMiddlewares = void 0;
const framework_1 = require("@medusajs/framework");
const utils_1 = require("@medusajs/framework/utils");
const QueryConfig = __importStar(require("./query-config"));
const query_config_1 = require("./query-config");
const validators_1 = require("./validators");
exports.adminProductOptionRoutesMiddlewares = [
    {
    ...
    },
    {
        ...
        matcher: "/admin/product-options/:id",
        middlewares: [
            (0, framework_1.validateAndTransformBody)(validators_1.AdminUpdateProductOption),
            (0, framework_1.validateAndTransformQuery)(validators_1.AdminGetProductOptionParams, QueryConfig.retrieveProductOptionsTransformQueryConfig),
        ],
        policies: [
            {
    ...
    },
    {
        ...
        middlewares: [
            (0, framework_1.validateAndTransformQuery)(validators_1.AdminGetProductOptionValuesParams, QueryConfig.listProductOptionValuesTransformQueryConfig),
        ],
        policies: [
            {
                resource: query_config_1.Entities.product_option,
            ...
            {
                resource: query_config_1.Entities.product_option_value,
                operation: utils_1.PolicyOperation.read,
            },
        ],
    },
    {
        ...
        middlewares: [
            (0, framework_1.validateAndTransformQuery)(validators_1.AdminGetProductOptionValueParams, QueryConfig.retrieveProductOptionValuesTransformQueryConfig),
        ],
        policies: [
            {
                resource: query_config_1.Entities.product_option_value,
    ...
    },
    {
        ...
        matcher: "/admin/product-options/:id/values/:value_id",
        middlewares: [
            (0, framework_1.validateAndTransformBody)(validators_1.AdminUpdateProductOptionValue),
            (0, framework_1.validateAndTransformQuery)(validators_1.AdminGetProductOptionValueParams, QueryConfig.retrieveProductOptionValuesTransformQueryConfig),
        ],
        policies: [
            {
