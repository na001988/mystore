...
export declare class Store {
    ...
    productOption: {
         ...
         * Learn more about the `fields` property in the [API reference](https://docs.medusajs.com/api/store/select-fields-and-relations).
         */
        list: (query?: FindParams & HttpTypes.StoreProductOptionListParams, headers?: ClientHeaders) => Promise<HttpTypes.StoreProductOptionListResponse>;
        /**
         ...
         * Learn more about the `fields` property in the [API reference](https://docs.medusajs.com/api/store/select-fields-and-relations).
         */
        retrieve: (id: string, query?: HttpTypes.StoreProductOptionParams, headers?: ClientHeaders) => Promise<HttpTypes.StoreProductOptionResponse>;
    };
    /**
     * @tags product
     */
