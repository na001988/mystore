...
class RbacRole {
    ...
    async list(queryParams, headers) {
        return await this.client.fetch(`/admin/rbac/roles`, {
            query: queryParams,
            headers,
        });
    }
    ...
    async retrieve(id, query, headers) {
        return await this.client.fetch(`/admin/rbac/roles/${id}`, {
            query,
            headers,
        });
    }
     ...
     * })
     */
    async listPolicies(roleId, queryParams, headers) {
        return await this.client.fetch(`/admin/rbac/roles/${roleId}/policies`, {
            query: queryParams,
            headers,
        });
    }
     ...
     * })
     */
    async listUsers(roleId, queryParams, headers) {
        return await this.client.fetch(`/admin/rbac/roles/${roleId}/users`, {
            query: queryParams,
            headers,
        });
    }
     ...
     * })
     */
    async addUsers(roleId, body, headers) {
        return await this.client.fetch(`/admin/rbac/roles/${roleId}/users`, {
            method: "POST",
            headers,
            body,
     ...
     * })
     */
    async removeUsers(roleId, body, headers) {
        return await this.client.fetch(`/admin/rbac/roles/${roleId}/users`, {
            method: "DELETE",
            headers,
            body,
     ...
     * })
     */
    async addPolicies(roleId, body, headers) {
        return await this.client.fetch(`/admin/rbac/roles/${roleId}/policies`, {
            method: "POST",
            headers,
            body,
     ...
     * })
     */
    async removePolicy(roleId, policyId, headers) {
        return await this.client.fetch(`/admin/rbac/roles/${roleId}/policies/${policyId}`, {
            method: "DELETE",
            headers,
        });
    }
     ...
     * })
     */
    async mePermissions(headers) {
        return await this.client.fetch(`/admin/rbac/me/permissions`, {
            method: "GET",
            headers,
        });
    }
     ...
     */
    async listAssignable(queryParams, headers) {
        return await this.client.fetch(`/admin/rbac/roles/assignable`, {
            method: "GET",
            query: queryParams,
            headers,
        });
