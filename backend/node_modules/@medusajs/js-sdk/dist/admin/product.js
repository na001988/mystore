...
class Product {
    ...
    constructor(client) {
         ...
         * })
         */
        this.import = async (body, query, headers) => {
     ...
     * })
     */
    async deleteVariant(productId, id, headers, query) {
        return await this.client.fetch(`/admin/products/${productId}/variants/${id}`, {
            method: "DELETE",
            headers,
            query,
     ...
     * })
     */
    async linkOptions(productId, body, query, headers) {
        return await this.client.fetch(`/admin/products/${productId}/options/batch`, {
            method: "POST",
            headers,
            body: body,
            query,
