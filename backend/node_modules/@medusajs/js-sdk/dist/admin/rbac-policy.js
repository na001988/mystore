...
class RbacPolicy {
    ...
    async list(queryParams, headers) {
        return await this.client.fetch(`/admin/rbac/policies`, {
            query: queryParams,
            headers,
        });
    }
    ...
    async retrieve(id, query, headers) {
        return await this.client.fetch(`/admin/rbac/policies/${id}`, {
            query,
            headers,
        });
    }
    ...
    async listRoles(id, queryParams, headers) {
        return await this.client.fetch(`/admin/rbac/policies/${id}/roles`, {
            query: queryParams,
            headers,
        });
    }
    ...
    async listAssignable(queryParams, headers) {
        return await this.client.fetch(`/admin/rbac/policies/assignable`, {
            method: "GET",
            query: queryParams,
            headers,
        });
