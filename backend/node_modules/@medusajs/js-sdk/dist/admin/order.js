...
class Order {
     ...
     * })
     */
    async transferToGuest(id, body, headers) {
        return await this.client.fetch(`/admin/orders/${id}/transfer/guest`, {
            method: "POST",
            headers,
            body,
        });
     ...
     * })
     */
    async authorizePaymentSession(id, paymentSessionId, query, headers) {
        return await this.client.fetch(`/admin/orders/${id}/payment-sessions/authorize`, {
            method: "POST",
            headers,
